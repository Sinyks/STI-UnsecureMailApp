    ...
    <?php foreach ($messages as $message) {
        ...
        <div class="card">
            <div class="card-header" id="headingOne">
                <h5 class="mb-0">
                    <button class="btn btn-link" data-toggle="collapse" data-target="<?php echo "#" . $collapse ?>"
                            aria-expanded="true" aria-controls="<?php echo $collapse ?>">
                        <?php
                        try {
...
<button class="btn btn-primary btn-lg btn-block" data-toggle="collapse" data-target="#MessageForm" aria-expanded="true"
